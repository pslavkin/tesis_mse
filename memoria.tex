...
\thesistitle{Lectura de fiduciales para máquina de control numérico CNC} % El títulos de la memoria, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \ttitle
...
\juradoUNO{Ing. Ariel Hernandez (Seeingmachines)} % Nombre y pertenencia del un jurado se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \jur1name
...
\ciudad{ciudad de San Carlos de Bariloche}
...
\keywords{Sistemas embebidos, FIUBA, CNC, lectura de marcas, GCode, Pablo Slavkin } % Keywords for your thesis, print it elsewhere with \keywordnames
...
\dedicatory{\textbf{Dedicado a Fernando Adrián Sanchez}}  % escribir acá si se desea una dedicatoria
