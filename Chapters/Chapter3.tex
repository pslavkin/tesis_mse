...
\section{Conexión de cámara a PocketBeagle}
...
Sobre la base del desarrollo de la página web de control, se extendió la aplicación y se implementó el sistema de alineación por lectura de marcas.
   En la figuras \ref{fig:web_mach1} y \ref{fig:web_mach2} se pueden ver aspectos destacados de esta página. En el apéndice \ref{AppendixB} se pueden ver mas imágenes en distintos escenarios de uso.
