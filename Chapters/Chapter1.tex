...
En el presente capitulo se expone la definicion, algo de historia, el principio de funcionamiento y ejemplos de uso de las maquinas CNC. Hacia el final del capitulo se introduce el problema de la alineacion de piezas en 2D.

%----------------------------------------------------------------------------------------
\section{Historia y principio de funcionamiento}
   
Hacia finales de la decada del '40, el mecanico, inventor y pionero reconocido Jhon Parson \footnote\jhonparsonwiki que se destaca en la figura \ref{fig:parsons}, logra motorizar una agujereadora de banco de precision y automatizarla con el uso de una cinta perforada. A este invento se lo considera la primera maquina de control numerico o NC por sus siglas en ingles \textit{numerical control}.
   \centering
   \begin{figure}[ht]
      \subfigab{0.35}{0.64}{parsons_face}{parsons_machine}
      \caption{Jhon Parsons en A, considerado el inventor de la maquina de control numerico NC. En B una de sus maquinas.}
      \label{fig:parsons}
   \end{figure}
\par
...
Aun con el paso del tiempo y la tecnologia, las partes principales de una maquina CNC se describen en la figura \ref{fig:cnc_bloques_basico} y son 3:
   \begin{enumerate}
      \item{programa}
      \item{unidad de control}
      \item{equipo de procesado}
   \end{enumerate}
   \centering
   \begin{figure}[ht]
      \includegraphics[width=1\textwidth]{cnc_bloques_basico.png}
      \caption{Los 3 compoenentes baicos de una maquina CNC.}
      \label{fig:cnc_bloques_basico}
   \end{figure}

o NC surgieron a principios de 1940 motorizando maquinas manuales para mecanizado como fresadoras y tornos. la decada del '40NC ) Si bien en alguna bibliografia se encuentran algunas referencias primigenias desde 1700, 
...
Se puede encontrar la versión en español en la lista en esta página: \url{http://www.ctan.org/tex-archive/info/lshort/}
   \centering
   \begin{figure}[ht]
      \subfigcab{0.69}{0.305}{wolfcut1.png}{wolfcut2.png}{wolfcut3.png}
      \caption{Maquinas CNC fabricadas por la empresa Wolfcut}
      \label{fig:wolfcut1}
   \end{figure}
